...
function criarElementoTarefa(tarefa){
    ...
    <path d="M9 16.1719L19.5938 5.5781L21 6.9844L9 18.9844L3.42188 13.4062L4.82812 12L9 16.1719Z"
    fill="#01080E"></path>
    </svg>
    `;
...
const imagemDoButton = document.createElement('img');
imagemDoButton.setAttribute('src', 'imagens/edit.png')

button.appendChild(imagemDoButton);
...
document.addEventListener('focoFinalizado', () => {
    if (
        tarefaSelecionada && liTarefaSelecionada
    ) {
